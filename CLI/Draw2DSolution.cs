...
public class Draw2DSolution
{
    public static void Draw(TwoDSolver.Solution solution)
    {
        ...
        svgContent.AppendLine(
            $"<svg width=\"{solution.Space.Width}\" height=\"{solution.Space.Height}\" xmlns=\"http://www.w3.org/2000/svg\">\n");
        ...
        foreach (var solvedProduct in solution.SolvedProducts)
        {
            ...
            svgContent.AppendLine(
                $"<rect x=\"{solvedProduct.Point.X}\" y=\"{solvedProduct.Point.Y}\" width=\"{solvedProduct.AdjustedWidth}\" height=\"{solvedProduct.AdjustedHeight}\" fill=\"{color}\" stroke=\"black\" stroke-width=\"1\" />");
        }
